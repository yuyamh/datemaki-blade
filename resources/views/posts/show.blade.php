<x-app-layout>
    ...
    <div class="px-10 py-5">
        ...
        <div class="flex justify-center my-9">
            <x-primary-button onclick="location.href='{{ route('posts.edit', $post) }}'" class="bg-orange-400 shadow-md hover:bg-orange-300">編集する</x-primary-button>
            <x-primary-button onclick="location.href='{{ route('posts.index') }}'" class="mx-12">戻る</x-primary-button>
