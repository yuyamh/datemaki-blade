...
<div class="lg:mr-6">
    ...
    <div class="mt-2 mb-5 text-right">
        <x-primary-button id="export-users" type="button" class="bg-green-500 shadow-md hover:bg-green-400 active:ring-offset-0 focus:ring-offset-0 active:bg-green-400 focus:bg-green-500 focus:ring-transparent">
